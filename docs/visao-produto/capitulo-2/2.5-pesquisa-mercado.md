...
| `1.3` | 19/09/2026 | Correção de terminologia: "correções de margem" substituído por "ajustes de precificação e correções de desvio orçamentário", alinhando com o escopo real do MVP | Paulo Nery | |

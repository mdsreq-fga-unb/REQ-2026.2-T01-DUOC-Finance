...
* **Técnicas e Práticas Empregadas:**
    * **Entrevistas Semiestruturadas com Stakeholder Chave:** Condução de reuniões síncronas com a auxiliar administrativa e ponto focal do cliente, Maria Beatryz, para mapear a rotina de fechamento de folha, gestão de canteiros e cálculo de comissões.

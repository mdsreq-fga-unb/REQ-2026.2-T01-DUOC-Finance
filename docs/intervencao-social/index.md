...
## Sumário do Capítulo
1. [3.1 Impactos Pretendidos](3.1-impactos-pretendidos.md)
2. [3.2 Efeitos Emergentes e Mitigações](3.2-efeitos-emergentes.md)
...
| :---: | :---: | :--- | :--- | :--- |
| `1.0` | 05/09/2026 | Estruturação inicial do sumário e objetivos de intervenção social | Matheus Ribeiro Szervinsk | Matheus Ribeiro Szervinsk |
| `1.1` | 07/09/2026 | Correção gramatical, contextualização sociotécnica e padronização | Matheus Ribeiro Szervinsk | Matheus Ribeiro Szervinsk |
| `1.2` | 07/09/2026 | Estruturação dos objetivos do capítulo em tópicos para otimização da leitura | Matheus Ribeiro Szervinsk | Matheus Ribeiro Szervinsk |